  ...
  return (
    <div>
      <div className="mx-auto mt-12 max-w-7xl bg-white px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
          <button onClick ={e=>{setShowAddAddressForm(true);setSelectedEditIndex(-1)}} type="submit" className="rounded-md my-5 bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600" >
                    Add New Address
          </button>
          { showAddAddressForm ?(<form className="bg-white px-5 py-12 mt-12"
            ...
            <div>
             { selectedEditIndex ===index ?(<form className="bg-white px-5 py-12 mt-12"
              ...
              <div className="flex justify-between gap-x-6 py-5 px-5 border-solid border-2 border-color-grey-200 p-2" >
